...
jQuery(document).ready(function () {
  jQuery('.mobile_footer .tfc_footer_menu_tab').click(function () {
    jQuery(this).children().find('div').toggle(300 ,'swing');
    jQuery(this).children().find('h3').toggleClass('rotate');
  
  // for contact
  jQuery(this).find('.tfc_mobile_contact').toggle(300 ,'swing');
  })
});
